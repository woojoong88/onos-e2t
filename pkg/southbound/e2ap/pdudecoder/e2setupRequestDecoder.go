...
func DecodeE2SetupRequest(request *e2appducontents.E2SetupRequest) (*int32, *types.E2NodeIdentity, *types.RanFunctions,
	...
	nodeIdentity, err = ExtractE2NodeIdentity(identifierIe.GetValue(), e2nccul)
...
func ExtractE2NodeIdentity(ge2nID *e2apies.GlobalE2NodeId, e2n interface{}) (*types.E2NodeIdentity, error) {
	var nodeIdentity *types.E2NodeIdentity
	var err error
